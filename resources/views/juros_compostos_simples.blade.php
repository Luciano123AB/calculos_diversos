...
@section("content")
    ...
    <form action="{{ route("calcular.juros.compostos.simples") }}" method="POST" novalidate class="mx-auto" style="max-width: 600px;">
        @csrf
        ...
        <div class="d-flex justify-content-center gap-3 mt-4">
            ...
            <button type="button" id="limpar" class="btn btn-outline-secondary fw-semibold px-4" onclick="limparCampos07()">
