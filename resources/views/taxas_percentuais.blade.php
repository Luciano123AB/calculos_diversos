...
@section("content")
    ...
    <form action="{{ route("calcular.taxas.percentuais") }}" method="POST" novalidate class="mx-auto" style="max-width: 600px;">
        @csrf
        ...
        <div class="input-group input-group-lg mb-3">
            ...
            <input type="number" id="taxa" name="taxa" class="form-control text-end" placeholder="000,0" aria-label="Taxa" value="{{ old("taxa") }}">
        ...
        <div class="d-flex justify-content-center gap-3 mt-4">
            ...
            <button type="button" id="limpar" class="btn btn-outline-secondary fw-semibold px-4" onclick="limparCampos08()">
