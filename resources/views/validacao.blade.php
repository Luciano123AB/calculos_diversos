...
@section("content")
    <nav class="bg-secondary border-bottom text-center py-5 shadow position-relative">
        <a href="{{ route("home") }}" class="btn btn-light position-absolute top-50 start-0 translate-middle-y ms-3 d-flex align-items-center gap-1 shadow-sm">
    ...
    <form action="{{ route("CalcularValidacao") }}" method="POST" novalidate class="mx-auto" style="max-width: 600px;">
        ...
        <div class="d-flex justify-content-center gap-3 mt-4">
            ...
            <button type="button" id="limpar" class="btn btn-outline-secondary fw-semibold px-4" onclick="limparCampos10()">
