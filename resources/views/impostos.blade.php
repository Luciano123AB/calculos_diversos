...
@section("content")
    <nav class="bg-secondary text-center py-5 shadow-sm position-relative">
        ...
        <span class="text-white fw-bold display-5">Imposto</span>
    </nav>
    ...
    <div class="container my-5">
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="card-header bg-info text-white text-center py-4">
                ...
                <h5 class="fw-light mb-0">Insira os valores abaixo para obter o imposto</h5>
            </div>

            <div class="card-body bg-light p-5">
                <form action="{{ route("CalcularImpostos") }}" method="POST" novalidate class="mx-auto" style="max-width: 600px;">
                    @csrf
                    ...
                    <div class="input-group input-group-lg mb-3">
                        ...
                        <input type="number" id="taxa" name="taxa" class="form-control text-end" placeholder="0" aria-label="Taxa" value="{{ old("taxa") }}">
                    ...
                    <div class="mt-4 text-center">
                        @if(!session()->has("imposto") && !session()->has("resultado"))
                            <h5 class="fw-normal text-secondary">Imposto: <span class="fw-bold text-dark">R$ 0,00</span></h5>
                            
                            <h4 class="fw-normal text-secondary">Resultado: <span class="fw-bold text-dark">R$ 0,00</span></h4>
                        @else
                            <h5 class="fw-normal text-secondary">
                                Imposto: <span class="fw-bold text-success">R$ {{ session("imposto") }}</span>
                            </h5>
